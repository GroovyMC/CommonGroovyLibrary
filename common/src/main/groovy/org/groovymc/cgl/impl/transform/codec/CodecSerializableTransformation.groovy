...
class CodecSerializableTransformation extends AbstractASTTransformation implements TransformWithPriority {
    ...
    static final ClassNode TUPLE_MAP_CODEC = makeWithoutCaching('org.groovymc.cgl.api.codec.TupleMapCodec')
    static final ClassNode MAP_COMMENT_SPEC = makeWithoutCaching('org.groovymc.cgl.api.codec.comments.MapCommentSpec')
