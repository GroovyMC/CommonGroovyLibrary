...
import io.github.groovymc.cgl.impl.transform.registroid.RecipeTypeAddonTransformer
 ...
 * {@linkplain io.github.groovymc.cgl.api.extension.StaticGeneralExtensions#simple(net.minecraft.resources.ResourceLocation)}, with the
