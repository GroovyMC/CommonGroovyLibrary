 ...
 * Moreover, {@linkplain io.github.groovymc.cgl.transform.registroid.RegistroidAddon addons} can be added to the DRs in the class by annotation the class with the respective {@linkplain io.github.groovymc.cgl.transform.registroid.RegistroidAddonClass addon annotations}.
 *
 * The way registry name are determined can be found in the {@linkplain io.github.groovymc.cgl.transform.registroid.RegistrationName RegistrationName} documentation.
 */
@Documented
@CompileStatic
...
@interface Registroid {
     ...
     * Only works on Forge, or if a custom {@linkplain io.github.groovymc.cgl.transform.util.ModClassTransformer.Helper} is implemented for your mod ID.
     */
     ...
     * On other platforms (Quilt / Common), specify the modId, or implement a custom {@linkplain io.github.groovymc.cgl.transform.util.ModIdRequester.Helper} using services, for your own package and modId.
     */
